...
// Helix charges in internal credits instead of exposing provider pricing.
...
function convertUsdToCredits(estimatedCostUsd: number) {
  // Charge at least 1 credit per request, then round up so partial credits
  // always become a whole credit. This also applies to currently free models.
